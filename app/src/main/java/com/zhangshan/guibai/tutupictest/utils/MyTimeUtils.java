...
public class MyTimeUtils {
	...
	public static String getDate2StringDate(Date date) {
	...
	// 日期转  05:23:45 这样的格式
	@SuppressLint("SimpleDateFormat")
	public static String getDate2StringTime(Date date) {
		try {
	 ...
	 * @return addDay - 增减多少天
	 */
	public static String getAddDayDate(int addDay) {

		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		Calendar rightNow = Calendar.getInstance();
		// rightNow.add(Calendar.YEAR,-1);//日期减1年
		// rightNow.add(Calendar.MONTH,3);//日期加3个月
		rightNow.add(Calendar.DAY_OF_YEAR, addDay);// 日期加 addDay 天
	...
	public static int getIntervalDays(Date date, Date otherDate) {
		date = MyTimeUtils.StringToDate(MyTimeUtils.getDate(date));
