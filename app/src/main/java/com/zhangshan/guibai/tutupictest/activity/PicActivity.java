...
import com.zhangshan.guibai.tutupictest.fragemnt.ExtendFilterFragment;
import com.zhangshan.guibai.tutupictest.utils.ToastUtil;

import butterknife.BindView;
import butterknife.ButterKnife;

public class PicActivity extends FragmentActivity implements TuEditFilterFragment.TuEditFilterFragmentDelegate{
    ...
    private FilterManager.FilterManagerDelegate mFilterManagerDelegate = new FilterManager.FilterManagerDelegate() {
        ...
        public void onFilterManagerInited(FilterManager manager) {
            ...
            fragment.setImage(BitmapHelper.getRawBitmap(PicActivity.this, R.raw.sample_photo));

            fragment.setDelegate(PicActivity.this);
                                             ...
                                             TuSdkResult result)
    {
        ...
        if (!image.equals(null)){
            ToastUtil.showToast(PicActivity.this , "bitmap 有值了,去保存吧");
        }
