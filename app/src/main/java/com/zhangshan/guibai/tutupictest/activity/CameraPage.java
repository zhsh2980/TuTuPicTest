...
import com.zhangshan.guibai.tutupictest.base.SampleBase;
...
public class CameraPage extends SampleBase implements TuCameraFragment.TuCameraFragmentDelegate {
    ...
    public void onTuCameraFragmentCaptured(TuCameraFragment fragment, TuSdkResult result) {
        ...
        ToastUtil.showToast(activity , "直接关闭了相机");
